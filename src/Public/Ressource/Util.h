/* Created by Thomas Lesieur, 9/03/2026: Added operators for points and color
    Modified by
        MS, 11/03/2026: moved #define for ImGui and testing to be in this file, Added function test()
*/
