...
{
	for (size_t i = 0; i != sizeof rectsHorizontaux / sizeof rectsHorizontaux[0] - 1; ++i)
		rectsHorizontaux[i] = Rectangle{ x, y + i * blockSize, 10 * blockSize, 2};
	for (size_t i = 0; i != sizeof rectsVerticaux / sizeof rectsVerticaux[0] - 1; ++i)
		rectsVerticaux[i] = Rectangle{ x + blockSize * i, y, 2, 20 * blockSize};
}
